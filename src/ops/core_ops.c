...
INTVAL core_numops = 1075;

/*
** Op Function Table:
*/

static op_func_t core_op_func_table[1075] = {
  Parrot_end,                                        /*      0 */
  Parrot_noop,                                       /*      1 */
  ...
  Parrot_invokecc_p_p,                               /*     24 */
  Parrot_invoke_p_p,                                 /*     25 */
  Parrot_yield,                                      /*     26 */
  Parrot_tailcall_p,                                 /*     27 */
  Parrot_returncc,                                   /*     28 */
  Parrot_capture_lex_p,                              /*     29 */
  Parrot_newclosure_p_p,                             /*     30 */
  Parrot_set_args_pc,                                /*     31 */
  Parrot_get_params_pc,                              /*     32 */
  Parrot_get_call_context_p,                         /*     33 */
  Parrot_new_call_context_p,                         /*     34 */
  Parrot_set_returns_pc,                             /*     35 */
  Parrot_get_results_pc,                             /*     36 */
  Parrot_set_result_info_p,                          /*     37 */
  Parrot_set_result_info_pc,                         /*     38 */
  ...
  Parrot_exit_i,                                     /*     61 */
  Parrot_exit_ic,                                    /*     62 */
  Parrot_finalize_p,                                 /*     63 */
  Parrot_finalize_pc,                                /*     64 */
  Parrot_debug_i,                                    /*     65 */
  Parrot_debug_ic,                                   /*     66 */
  Parrot_bounds_i,                                   /*     67 */
  Parrot_bounds_ic,                                  /*     68 */
  ...
  Parrot_loadlib_p_s_p,                              /*    101 */
  Parrot_loadlib_p_sc_p,                             /*    102 */
  Parrot_loadlib_p_s_pc,                             /*    103 */
  Parrot_loadlib_p_sc_pc,                            /*    104 */
  Parrot_dlfunc_p_p_s_s,                             /*    105 */
  Parrot_dlfunc_p_p_sc_s,                            /*    106 */
  Parrot_dlfunc_p_p_s_sc,                            /*    107 */
  Parrot_dlfunc_p_p_sc_sc,                           /*    108 */
  Parrot_dlfunc_p_p_s_p,                             /*    109 */
  Parrot_dlfunc_p_p_sc_p,                            /*    110 */
  Parrot_dlvar_p_p_s,                                /*    111 */
  Parrot_dlvar_p_p_sc,                               /*    112 */
  Parrot_compreg_s_p,                                /*    113 */
  Parrot_compreg_sc_p,                               /*    114 */
  Parrot_compreg_p_s,                                /*    115 */
  Parrot_compreg_p_sc,                               /*    116 */
  Parrot_new_callback_p_p_p_s,                       /*    117 */
  Parrot_new_callback_p_p_p_sc,                      /*    118 */
  Parrot_annotations_p,                              /*    119 */
  Parrot_annotations_p_s,                            /*    120 */
  Parrot_annotations_p_sc,                           /*    121 */
  Parrot_band_i_i,                                   /*    122 */
  Parrot_band_i_ic,                                  /*    123 */
  Parrot_band_i_i_i,                                 /*    124 */
  Parrot_band_i_ic_i,                                /*    125 */
  Parrot_band_i_i_ic,                                /*    126 */
  Parrot_bor_i_i,                                    /*    127 */
  Parrot_bor_i_ic,                                   /*    128 */
  Parrot_bor_i_i_i,                                  /*    129 */
  Parrot_bor_i_ic_i,                                 /*    130 */
  Parrot_bor_i_i_ic,                                 /*    131 */
  Parrot_shl_i_i,                                    /*    132 */
  Parrot_shl_i_ic,                                   /*    133 */
  Parrot_shl_i_i_i,                                  /*    134 */
  Parrot_shl_i_ic_i,                                 /*    135 */
  Parrot_shl_i_i_ic,                                 /*    136 */
  Parrot_shr_i_i,                                    /*    137 */
  Parrot_shr_i_ic,                                   /*    138 */
  Parrot_shr_i_i_i,                                  /*    139 */
  Parrot_shr_i_ic_i,                                 /*    140 */
  Parrot_shr_i_i_ic,                                 /*    141 */
  Parrot_lsr_i_i,                                    /*    142 */
  Parrot_lsr_i_ic,                                   /*    143 */
  Parrot_lsr_i_i_i,                                  /*    144 */
  Parrot_lsr_i_ic_i,                                 /*    145 */
  Parrot_lsr_i_i_ic,                                 /*    146 */
  Parrot_bxor_i_i,                                   /*    147 */
  Parrot_bxor_i_ic,                                  /*    148 */
  Parrot_bxor_i_i_i,                                 /*    149 */
  Parrot_bxor_i_ic_i,                                /*    150 */
  Parrot_bxor_i_i_ic,                                /*    151 */
  Parrot_eq_i_i_ic,                                  /*    152 */
  Parrot_eq_ic_i_ic,                                 /*    153 */
  Parrot_eq_i_ic_ic,                                 /*    154 */
  Parrot_eq_n_n_ic,                                  /*    155 */
  Parrot_eq_nc_n_ic,                                 /*    156 */
  Parrot_eq_n_nc_ic,                                 /*    157 */
  Parrot_eq_s_s_ic,                                  /*    158 */
  Parrot_eq_sc_s_ic,                                 /*    159 */
  Parrot_eq_s_sc_ic,                                 /*    160 */
  Parrot_eq_p_p_ic,                                  /*    161 */
  Parrot_eq_p_i_ic,                                  /*    162 */
  Parrot_eq_p_ic_ic,                                 /*    163 */
  Parrot_eq_p_n_ic,                                  /*    164 */
  Parrot_eq_p_nc_ic,                                 /*    165 */
  Parrot_eq_p_s_ic,                                  /*    166 */
  Parrot_eq_p_sc_ic,                                 /*    167 */
  Parrot_eq_str_p_p_ic,                              /*    168 */
  Parrot_eq_num_p_p_ic,                              /*    169 */
  Parrot_eq_addr_s_s_ic,                             /*    170 */
  Parrot_eq_addr_sc_s_ic,                            /*    171 */
  Parrot_eq_addr_s_sc_ic,                            /*    172 */
  Parrot_eq_addr_sc_sc_ic,                           /*    173 */
  Parrot_eq_addr_p_p_ic,                             /*    174 */
  Parrot_ne_i_i_ic,                                  /*    175 */
  Parrot_ne_ic_i_ic,                                 /*    176 */
  Parrot_ne_i_ic_ic,                                 /*    177 */
  Parrot_ne_n_n_ic,                                  /*    178 */
  Parrot_ne_nc_n_ic,                                 /*    179 */
  Parrot_ne_n_nc_ic,                                 /*    180 */
  Parrot_ne_s_s_ic,                                  /*    181 */
  Parrot_ne_sc_s_ic,                                 /*    182 */
  Parrot_ne_s_sc_ic,                                 /*    183 */
  Parrot_ne_p_p_ic,                                  /*    184 */
  Parrot_ne_p_i_ic,                                  /*    185 */
  Parrot_ne_p_ic_ic,                                 /*    186 */
  Parrot_ne_p_n_ic,                                  /*    187 */
  Parrot_ne_p_nc_ic,                                 /*    188 */
  Parrot_ne_p_s_ic,                                  /*    189 */
  Parrot_ne_p_sc_ic,                                 /*    190 */
  Parrot_ne_str_p_p_ic,                              /*    191 */
  Parrot_ne_num_p_p_ic,                              /*    192 */
  Parrot_ne_addr_s_s_ic,                             /*    193 */
  Parrot_ne_addr_sc_s_ic,                            /*    194 */
  Parrot_ne_addr_s_sc_ic,                            /*    195 */
  Parrot_ne_addr_sc_sc_ic,                           /*    196 */
  Parrot_ne_addr_p_p_ic,                             /*    197 */
  Parrot_lt_i_i_ic,                                  /*    198 */
  Parrot_lt_ic_i_ic,                                 /*    199 */
  Parrot_lt_i_ic_ic,                                 /*    200 */
  Parrot_lt_n_n_ic,                                  /*    201 */
  Parrot_lt_nc_n_ic,                                 /*    202 */
  Parrot_lt_n_nc_ic,                                 /*    203 */
  Parrot_lt_s_s_ic,                                  /*    204 */
  Parrot_lt_sc_s_ic,                                 /*    205 */
  Parrot_lt_s_sc_ic,                                 /*    206 */
  Parrot_lt_p_p_ic,                                  /*    207 */
  Parrot_lt_p_i_ic,                                  /*    208 */
  Parrot_lt_p_ic_ic,                                 /*    209 */
  Parrot_lt_p_n_ic,                                  /*    210 */
  Parrot_lt_p_nc_ic,                                 /*    211 */
  Parrot_lt_p_s_ic,                                  /*    212 */
  Parrot_lt_p_sc_ic,                                 /*    213 */
  Parrot_lt_str_p_p_ic,                              /*    214 */
  Parrot_lt_num_p_p_ic,                              /*    215 */
  Parrot_le_i_i_ic,                                  /*    216 */
  Parrot_le_ic_i_ic,                                 /*    217 */
  Parrot_le_i_ic_ic,                                 /*    218 */
  Parrot_le_n_n_ic,                                  /*    219 */
  Parrot_le_nc_n_ic,                                 /*    220 */
  Parrot_le_n_nc_ic,                                 /*    221 */
  Parrot_le_s_s_ic,                                  /*    222 */
  Parrot_le_sc_s_ic,                                 /*    223 */
  Parrot_le_s_sc_ic,                                 /*    224 */
  Parrot_le_p_p_ic,                                  /*    225 */
  Parrot_le_p_i_ic,                                  /*    226 */
  Parrot_le_p_ic_ic,                                 /*    227 */
  Parrot_le_p_n_ic,                                  /*    228 */
  Parrot_le_p_nc_ic,                                 /*    229 */
  Parrot_le_p_s_ic,                                  /*    230 */
  Parrot_le_p_sc_ic,                                 /*    231 */
  Parrot_le_str_p_p_ic,                              /*    232 */
  Parrot_le_num_p_p_ic,                              /*    233 */
  Parrot_gt_p_p_ic,                                  /*    234 */
  Parrot_gt_p_i_ic,                                  /*    235 */
  Parrot_gt_p_ic_ic,                                 /*    236 */
  Parrot_gt_p_n_ic,                                  /*    237 */
  Parrot_gt_p_nc_ic,                                 /*    238 */
  Parrot_gt_p_s_ic,                                  /*    239 */
  Parrot_gt_p_sc_ic,                                 /*    240 */
  Parrot_gt_str_p_p_ic,                              /*    241 */
  Parrot_gt_num_p_p_ic,                              /*    242 */
  Parrot_ge_p_p_ic,                                  /*    243 */
  Parrot_ge_p_i_ic,                                  /*    244 */
  Parrot_ge_p_ic_ic,                                 /*    245 */
  Parrot_ge_p_n_ic,                                  /*    246 */
  Parrot_ge_p_nc_ic,                                 /*    247 */
  Parrot_ge_p_s_ic,                                  /*    248 */
  Parrot_ge_p_sc_ic,                                 /*    249 */
  Parrot_ge_str_p_p_ic,                              /*    250 */
  Parrot_ge_num_p_p_ic,                              /*    251 */
  Parrot_if_null_p_ic,                               /*    252 */
  Parrot_if_null_s_ic,                               /*    253 */
  Parrot_unless_null_p_ic,                           /*    254 */
  Parrot_unless_null_s_ic,                           /*    255 */
  Parrot_cmp_i_i_i,                                  /*    256 */
  Parrot_cmp_i_ic_i,                                 /*    257 */
  Parrot_cmp_i_i_ic,                                 /*    258 */
  Parrot_cmp_i_n_n,                                  /*    259 */
  Parrot_cmp_i_nc_n,                                 /*    260 */
  Parrot_cmp_i_n_nc,                                 /*    261 */
  Parrot_cmp_i_s_s,                                  /*    262 */
  Parrot_cmp_i_sc_s,                                 /*    263 */
  Parrot_cmp_i_s_sc,                                 /*    264 */
  Parrot_cmp_i_p_p,                                  /*    265 */
  Parrot_cmp_i_p_i,                                  /*    266 */
  Parrot_cmp_i_p_ic,                                 /*    267 */
  Parrot_cmp_i_p_n,                                  /*    268 */
  Parrot_cmp_i_p_nc,                                 /*    269 */
  Parrot_cmp_i_p_s,                                  /*    270 */
  Parrot_cmp_i_p_sc,                                 /*    271 */
  Parrot_cmp_str_i_p_p,                              /*    272 */
  Parrot_cmp_num_i_p_p,                              /*    273 */
  Parrot_cmp_pmc_p_p_p,                              /*    274 */
  Parrot_issame_i_p_p,                               /*    275 */
  Parrot_issame_i_s_s,                               /*    276 */
  Parrot_issame_i_sc_s,                              /*    277 */
  Parrot_issame_i_s_sc,                              /*    278 */
  Parrot_issame_i_sc_sc,                             /*    279 */
  Parrot_isntsame_i_p_p,                             /*    280 */
  Parrot_isntsame_i_s_s,                             /*    281 */
  Parrot_isntsame_i_sc_s,                            /*    282 */
  Parrot_isntsame_i_s_sc,                            /*    283 */
  Parrot_isntsame_i_sc_sc,                           /*    284 */
  Parrot_istrue_i_p,                                 /*    285 */
  Parrot_isfalse_i_p,                                /*    286 */
  Parrot_isnull_i_p,                                 /*    287 */
  Parrot_isnull_i_pc,                                /*    288 */
  Parrot_isnull_i_s,                                 /*    289 */
  Parrot_isnull_i_sc,                                /*    290 */
  Parrot_isgt_i_p_p,                                 /*    291 */
  Parrot_isge_i_p_p,                                 /*    292 */
  Parrot_isle_i_i_i,                                 /*    293 */
  Parrot_isle_i_ic_i,                                /*    294 */
  Parrot_isle_i_i_ic,                                /*    295 */
  Parrot_isle_i_n_n,                                 /*    296 */
  Parrot_isle_i_nc_n,                                /*    297 */
  Parrot_isle_i_n_nc,                                /*    298 */
  Parrot_isle_i_s_s,                                 /*    299 */
  Parrot_isle_i_sc_s,                                /*    300 */
  Parrot_isle_i_s_sc,                                /*    301 */
  Parrot_isle_i_p_p,                                 /*    302 */
  Parrot_islt_i_i_i,                                 /*    303 */
  Parrot_islt_i_ic_i,                                /*    304 */
  Parrot_islt_i_i_ic,                                /*    305 */
  Parrot_islt_i_n_n,                                 /*    306 */
  Parrot_islt_i_nc_n,                                /*    307 */
  Parrot_islt_i_n_nc,                                /*    308 */
  Parrot_islt_i_s_s,                                 /*    309 */
  Parrot_islt_i_sc_s,                                /*    310 */
  Parrot_islt_i_s_sc,                                /*    311 */
  Parrot_islt_i_p_p,                                 /*    312 */
  Parrot_iseq_i_i_i,                                 /*    313 */
  Parrot_iseq_i_ic_i,                                /*    314 */
  Parrot_iseq_i_i_ic,                                /*    315 */
  Parrot_iseq_i_n_n,                                 /*    316 */
  Parrot_iseq_i_nc_n,                                /*    317 */
  Parrot_iseq_i_n_nc,                                /*    318 */
  Parrot_iseq_i_s_s,                                 /*    319 */
  Parrot_iseq_i_sc_s,                                /*    320 */
  Parrot_iseq_i_s_sc,                                /*    321 */
  Parrot_iseq_i_p_p,                                 /*    322 */
  Parrot_isne_i_i_i,                                 /*    323 */
  Parrot_isne_i_ic_i,                                /*    324 */
  Parrot_isne_i_i_ic,                                /*    325 */
  Parrot_isne_i_n_n,                                 /*    326 */
  Parrot_isne_i_nc_n,                                /*    327 */
  Parrot_isne_i_n_nc,                                /*    328 */
  Parrot_isne_i_s_s,                                 /*    329 */
  Parrot_isne_i_sc_s,                                /*    330 */
  Parrot_isne_i_s_sc,                                /*    331 */
  Parrot_isne_i_p_p,                                 /*    332 */
  Parrot_and_i_i_i,                                  /*    333 */
  Parrot_and_i_ic_i,                                 /*    334 */
  Parrot_and_i_i_ic,                                 /*    335 */
  Parrot_and_p_p_p,                                  /*    336 */
  Parrot_not_i,                                      /*    337 */
  Parrot_not_i_i,                                    /*    338 */
  Parrot_not_p,                                      /*    339 */
  Parrot_not_p_p,                                    /*    340 */
  Parrot_or_i_i_i,                                   /*    341 */
  Parrot_or_i_ic_i,                                  /*    342 */
  Parrot_or_i_i_ic,                                  /*    343 */
  Parrot_or_p_p_p,                                   /*    344 */
  Parrot_xor_i_i_i,                                  /*    345 */
  Parrot_xor_i_ic_i,                                 /*    346 */
  Parrot_xor_i_i_ic,                                 /*    347 */
  Parrot_xor_p_p_p,                                  /*    348 */
  Parrot_print_i,                                    /*    349 */
  Parrot_print_ic,                                   /*    350 */
  Parrot_print_n,                                    /*    351 */
  Parrot_print_nc,                                   /*    352 */
  ...
  Parrot_say_sc,                                     /*    361 */
  Parrot_say_p,                                      /*    362 */
  Parrot_print_p_i,                                  /*    363 */
  Parrot_print_p_ic,                                 /*    364 */
  Parrot_print_p_n,                                  /*    365 */
  Parrot_print_p_nc,                                 /*    366 */
  Parrot_print_p_s,                                  /*    367 */
  Parrot_print_p_sc,                                 /*    368 */
  Parrot_print_p_p,                                  /*    369 */
  Parrot_getstdin_p,                                 /*    370 */
  Parrot_getstdout_p,                                /*    371 */
  Parrot_getstderr_p,                                /*    372 */
  Parrot_abs_i,                                      /*    373 */
  Parrot_abs_n,                                      /*    374 */
  Parrot_abs_i_i,                                    /*    375 */
  Parrot_abs_n_n,                                    /*    376 */
  ...
  Parrot_add_p_n,                                    /*    386 */
  Parrot_add_p_nc,                                   /*    387 */
  Parrot_add_i_i_i,                                  /*    388 */
  Parrot_add_i_ic_i,                                 /*    389 */
  Parrot_add_i_i_ic,                                 /*    390 */
  Parrot_add_n_n_n,                                  /*    391 */
  Parrot_add_n_nc_n,                                 /*    392 */
  Parrot_add_n_n_nc,                                 /*    393 */
  Parrot_add_p_p_p,                                  /*    394 */
  Parrot_add_p_p_i,                                  /*    395 */
  Parrot_add_p_p_ic,                                 /*    396 */
  Parrot_add_p_p_n,                                  /*    397 */
  Parrot_add_p_p_nc,                                 /*    398 */
  Parrot_dec_i,                                      /*    399 */
  Parrot_dec_n,                                      /*    400 */
  Parrot_dec_p,                                      /*    401 */
  Parrot_div_i_i,                                    /*    402 */
  ...
  Parrot_div_p_n,                                    /*    409 */
  Parrot_div_p_nc,                                   /*    410 */
  Parrot_div_i_i_i,                                  /*    411 */
  Parrot_div_i_ic_i,                                 /*    412 */
  Parrot_div_i_i_ic,                                 /*    413 */
  Parrot_div_i_ic_ic,                                /*    414 */
  Parrot_div_n_n_n,                                  /*    415 */
  Parrot_div_n_nc_n,                                 /*    416 */
  Parrot_div_n_n_nc,                                 /*    417 */
  Parrot_div_n_nc_nc,                                /*    418 */
  Parrot_div_p_p_p,                                  /*    419 */
  Parrot_div_p_p_i,                                  /*    420 */
  Parrot_div_p_p_ic,                                 /*    421 */
  Parrot_div_p_p_n,                                  /*    422 */
  Parrot_div_p_p_nc,                                 /*    423 */
  Parrot_fdiv_i_i,                                   /*    424 */
  Parrot_fdiv_i_ic,                                  /*    425 */
  Parrot_fdiv_n_n,                                   /*    426 */
  Parrot_fdiv_n_nc,                                  /*    427 */
  Parrot_fdiv_p_p,                                   /*    428 */
  Parrot_fdiv_p_i,                                   /*    429 */
  Parrot_fdiv_p_ic,                                  /*    430 */
  Parrot_fdiv_p_n,                                   /*    431 */
  Parrot_fdiv_p_nc,                                  /*    432 */
  Parrot_fdiv_i_i_i,                                 /*    433 */
  Parrot_fdiv_i_ic_i,                                /*    434 */
  Parrot_fdiv_i_i_ic,                                /*    435 */
  Parrot_fdiv_n_n_n,                                 /*    436 */
  Parrot_fdiv_n_nc_n,                                /*    437 */
  Parrot_fdiv_n_n_nc,                                /*    438 */
  Parrot_fdiv_p_p_p,                                 /*    439 */
  Parrot_fdiv_p_p_i,                                 /*    440 */
  Parrot_fdiv_p_p_ic,                                /*    441 */
  Parrot_fdiv_p_p_n,                                 /*    442 */
  Parrot_fdiv_p_p_nc,                                /*    443 */
  Parrot_ceil_n,                                     /*    444 */
  Parrot_ceil_i_n,                                   /*    445 */
  Parrot_ceil_n_n,                                   /*    446 */
  Parrot_floor_n,                                    /*    447 */
  Parrot_floor_i_n,                                  /*    448 */
  Parrot_floor_n_n,                                  /*    449 */
  Parrot_inc_i,                                      /*    450 */
  Parrot_inc_n,                                      /*    451 */
  Parrot_inc_p,                                      /*    452 */
  Parrot_mod_i_i,                                    /*    453 */
  ...
  Parrot_mod_p_n,                                    /*    460 */
  Parrot_mod_p_nc,                                   /*    461 */
  Parrot_mod_i_i_i,                                  /*    462 */
  Parrot_mod_i_ic_i,                                 /*    463 */
  Parrot_mod_i_i_ic,                                 /*    464 */
  Parrot_mod_n_n_n,                                  /*    465 */
  Parrot_mod_n_nc_n,                                 /*    466 */
  Parrot_mod_n_n_nc,                                 /*    467 */
  Parrot_mod_p_p_p,                                  /*    468 */
  Parrot_mod_p_p_i,                                  /*    469 */
  Parrot_mod_p_p_ic,                                 /*    470 */
  Parrot_mod_p_p_n,                                  /*    471 */
  Parrot_mod_p_p_nc,                                 /*    472 */
  Parrot_mul_i_i,                                    /*    473 */
  Parrot_mul_i_ic,                                   /*    474 */
  Parrot_mul_n_n,                                    /*    475 */
  Parrot_mul_n_nc,                                   /*    476 */
  ...
  Parrot_mul_p_n,                                    /*    480 */
  Parrot_mul_p_nc,                                   /*    481 */
  Parrot_mul_i_i_i,                                  /*    482 */
  Parrot_mul_i_ic_i,                                 /*    483 */
  Parrot_mul_i_i_ic,                                 /*    484 */
  Parrot_mul_n_n_n,                                  /*    485 */
  Parrot_mul_n_nc_n,                                 /*    486 */
  Parrot_mul_n_n_nc,                                 /*    487 */
  Parrot_mul_p_p_p,                                  /*    488 */
  Parrot_mul_p_p_i,                                  /*    489 */
  Parrot_mul_p_p_ic,                                 /*    490 */
  Parrot_mul_p_p_n,                                  /*    491 */
  Parrot_mul_p_p_nc,                                 /*    492 */
  Parrot_neg_i,                                      /*    493 */
  Parrot_neg_n,                                      /*    494 */
  Parrot_neg_p,                                      /*    495 */
  Parrot_neg_i_i,                                    /*    496 */
  ...
  Parrot_sub_p_n,                                    /*    506 */
  Parrot_sub_p_nc,                                   /*    507 */
  Parrot_sub_i_i_i,                                  /*    508 */
  Parrot_sub_i_ic_i,                                 /*    509 */
  Parrot_sub_i_i_ic,                                 /*    510 */
  Parrot_sub_n_n_n,                                  /*    511 */
  Parrot_sub_n_nc_n,                                 /*    512 */
  Parrot_sub_n_n_nc,                                 /*    513 */
  Parrot_sub_p_p_p,                                  /*    514 */
  Parrot_sub_p_p_i,                                  /*    515 */
  Parrot_sub_p_p_ic,                                 /*    516 */
  Parrot_sub_p_p_n,                                  /*    517 */
  Parrot_sub_p_p_nc,                                 /*    518 */
  Parrot_sqrt_n_n,                                   /*    519 */
  Parrot_callmethodcc_p_s,                           /*    520 */
  Parrot_callmethodcc_p_sc,                          /*    521 */
  Parrot_callmethodcc_p_p,                           /*    522 */
  Parrot_callmethod_p_s_p,                           /*    523 */
  Parrot_callmethod_p_sc_p,                          /*    524 */
  Parrot_callmethod_p_p_p,                           /*    525 */
  Parrot_tailcallmethod_p_s,                         /*    526 */
  Parrot_tailcallmethod_p_sc,                        /*    527 */
  Parrot_tailcallmethod_p_p,                         /*    528 */
  Parrot_addmethod_p_s_p,                            /*    529 */
  Parrot_addmethod_p_sc_p,                           /*    530 */
  Parrot_can_i_p_s,                                  /*    531 */
  Parrot_can_i_p_sc,                                 /*    532 */
  Parrot_does_i_p_s,                                 /*    533 */
  Parrot_does_i_p_sc,                                /*    534 */
  Parrot_does_i_p_p,                                 /*    535 */
  Parrot_does_i_p_pc,                                /*    536 */
  Parrot_isa_i_p_s,                                  /*    537 */
  Parrot_isa_i_p_sc,                                 /*    538 */
  Parrot_isa_i_p_p,                                  /*    539 */
  Parrot_isa_i_p_pc,                                 /*    540 */
  Parrot_newclass_p_s,                               /*    541 */
  Parrot_newclass_p_sc,                              /*    542 */
  Parrot_newclass_p_p,                               /*    543 */
  Parrot_newclass_p_pc,                              /*    544 */
  Parrot_subclass_p_p,                               /*    545 */
  Parrot_subclass_p_pc,                              /*    546 */
  Parrot_subclass_p_p_s,                             /*    547 */
  Parrot_subclass_p_pc_s,                            /*    548 */
  Parrot_subclass_p_p_sc,                            /*    549 */
  Parrot_subclass_p_pc_sc,                           /*    550 */
  Parrot_subclass_p_p_p,                             /*    551 */
  Parrot_subclass_p_pc_p,                            /*    552 */
  Parrot_subclass_p_p_pc,                            /*    553 */
  Parrot_subclass_p_pc_pc,                           /*    554 */
  Parrot_subclass_p_s,                               /*    555 */
  Parrot_subclass_p_sc,                              /*    556 */
  Parrot_subclass_p_s_s,                             /*    557 */
  Parrot_subclass_p_sc_s,                            /*    558 */
  Parrot_subclass_p_s_sc,                            /*    559 */
  Parrot_subclass_p_sc_sc,                           /*    560 */
  Parrot_subclass_p_s_p,                             /*    561 */
  Parrot_subclass_p_sc_p,                            /*    562 */
  Parrot_subclass_p_s_pc,                            /*    563 */
  Parrot_subclass_p_sc_pc,                           /*    564 */
  Parrot_get_class_p_s,                              /*    565 */
  Parrot_get_class_p_sc,                             /*    566 */
  Parrot_get_class_p_p,                              /*    567 */
  Parrot_get_class_p_pc,                             /*    568 */
  Parrot_class_p_p,                                  /*    569 */
  Parrot_addparent_p_p,                              /*    570 */
  Parrot_removeparent_p_p,                           /*    571 */
  Parrot_addrole_p_p,                                /*    572 */
  Parrot_addattribute_p_s,                           /*    573 */
  Parrot_addattribute_p_sc,                          /*    574 */
  Parrot_removeattribute_p_s,                        /*    575 */
  Parrot_removeattribute_p_sc,                       /*    576 */
  Parrot_getattribute_p_p_s,                         /*    577 */
  Parrot_getattribute_p_p_sc,                        /*    578 */
  Parrot_getattribute_p_p_p_s,                       /*    579 */
  Parrot_getattribute_p_p_pc_s,                      /*    580 */
  Parrot_getattribute_p_p_p_sc,                      /*    581 */
  Parrot_getattribute_p_p_pc_sc,                     /*    582 */
  Parrot_setattribute_p_s_p,                         /*    583 */
  Parrot_setattribute_p_sc_p,                        /*    584 */
  Parrot_setattribute_p_p_s_p,                       /*    585 */
  Parrot_setattribute_p_pc_s_p,                      /*    586 */
  Parrot_setattribute_p_p_sc_p,                      /*    587 */
  Parrot_setattribute_p_pc_sc_p,                     /*    588 */
  Parrot_inspect_p_p,                                /*    589 */
  Parrot_inspect_p_pc,                               /*    590 */
  Parrot_inspect_p_p_s,                              /*    591 */
  Parrot_inspect_p_pc_s,                             /*    592 */
  Parrot_inspect_p_p_sc,                             /*    593 */
  Parrot_inspect_p_pc_sc,                            /*    594 */
  Parrot_new_p_s,                                    /*    595 */
  Parrot_new_p_sc,                                   /*    596 */
  Parrot_new_p_s_p,                                  /*    597 */
  Parrot_new_p_sc_p,                                 /*    598 */
  Parrot_new_p_s_pc,                                 /*    599 */
  Parrot_new_p_sc_pc,                                /*    600 */
  Parrot_new_p_p,                                    /*    601 */
  Parrot_new_p_pc,                                   /*    602 */
  Parrot_new_p_p_p,                                  /*    603 */
  Parrot_new_p_pc_p,                                 /*    604 */
  Parrot_new_p_p_pc,                                 /*    605 */
  Parrot_new_p_pc_pc,                                /*    606 */
  Parrot_root_new_p_p,                               /*    607 */
  Parrot_root_new_p_pc,                              /*    608 */
  Parrot_root_new_p_p_p,                             /*    609 */
  Parrot_root_new_p_pc_p,                            /*    610 */
  Parrot_root_new_p_p_pc,                            /*    611 */
  Parrot_root_new_p_pc_pc,                           /*    612 */
  Parrot_typeof_s_p,                                 /*    613 */
  Parrot_typeof_p_p,                                 /*    614 */
  Parrot_get_repr_s_p,                               /*    615 */
  Parrot_find_method_p_p_s,                          /*    616 */
  Parrot_find_method_p_p_sc,                         /*    617 */
  Parrot_defined_i_p,                                /*    618 */
  Parrot_defined_i_p_ki,                             /*    619 */
  Parrot_defined_i_p_kic,                            /*    620 */
  Parrot_defined_i_p_k,                              /*    621 */
  Parrot_defined_i_p_kc,                             /*    622 */
  Parrot_exists_i_p_ki,                              /*    623 */
  Parrot_exists_i_p_kic,                             /*    624 */
  Parrot_exists_i_p_k,                               /*    625 */
  Parrot_exists_i_p_kc,                              /*    626 */
  Parrot_delete_p_k,                                 /*    627 */
  Parrot_delete_p_kc,                                /*    628 */
  Parrot_delete_p_ki,                                /*    629 */
  Parrot_delete_p_kic,                               /*    630 */
  Parrot_elements_i_p,                               /*    631 */
  Parrot_push_p_i,                                   /*    632 */
  Parrot_push_p_ic,                                  /*    633 */
  Parrot_push_p_n,                                   /*    634 */
  Parrot_push_p_nc,                                  /*    635 */
  Parrot_push_p_s,                                   /*    636 */
  Parrot_push_p_sc,                                  /*    637 */
  Parrot_push_p_p,                                   /*    638 */
  Parrot_pop_i_p,                                    /*    639 */
  Parrot_pop_n_p,                                    /*    640 */
  Parrot_pop_s_p,                                    /*    641 */
  Parrot_pop_p_p,                                    /*    642 */
  Parrot_unshift_p_i,                                /*    643 */
  Parrot_unshift_p_ic,                               /*    644 */
  Parrot_unshift_p_n,                                /*    645 */
  Parrot_unshift_p_nc,                               /*    646 */
  Parrot_unshift_p_s,                                /*    647 */
  Parrot_unshift_p_sc,                               /*    648 */
  Parrot_unshift_p_p,                                /*    649 */
  Parrot_shift_i_p,                                  /*    650 */
  Parrot_shift_n_p,                                  /*    651 */
  Parrot_shift_s_p,                                  /*    652 */
  Parrot_shift_p_p,                                  /*    653 */
  Parrot_splice_p_p_i_i,                             /*    654 */
  Parrot_splice_p_p_ic_i,                            /*    655 */
  Parrot_splice_p_p_i_ic,                            /*    656 */
  Parrot_splice_p_p_ic_ic,                           /*    657 */
  Parrot_setprop_p_s_p,                              /*    658 */
  Parrot_setprop_p_sc_p,                             /*    659 */
  Parrot_getprop_p_s_p,                              /*    660 */
  Parrot_getprop_p_sc_p,                             /*    661 */
  Parrot_delprop_p_s,                                /*    662 */
  Parrot_delprop_p_sc,                               /*    663 */
  Parrot_prophash_p_p,                               /*    664 */
  Parrot_freeze_s_p,                                 /*    665 */
  Parrot_thaw_p_s,                                   /*    666 */
  Parrot_thaw_p_sc,                                  /*    667 */
  Parrot_add_multi_s_s_p,                            /*    668 */
  Parrot_add_multi_sc_s_p,                           /*    669 */
  Parrot_add_multi_s_sc_p,                           /*    670 */
  Parrot_add_multi_sc_sc_p,                          /*    671 */
  Parrot_find_multi_p_s_s,                           /*    672 */
  Parrot_find_multi_p_sc_s,                          /*    673 */
  Parrot_find_multi_p_s_sc,                          /*    674 */
  Parrot_find_multi_p_sc_sc,                         /*    675 */
  Parrot_register_p,                                 /*    676 */
  Parrot_unregister_p,                               /*    677 */
  Parrot_box_p_i,                                    /*    678 */
  Parrot_box_p_ic,                                   /*    679 */
  Parrot_box_p_n,                                    /*    680 */
  Parrot_box_p_nc,                                   /*    681 */
  ...
  Parrot_box_p_sc,                                   /*    683 */
  Parrot_iter_p_p,                                   /*    684 */
  Parrot_morph_p_p,                                  /*    685 */
  Parrot_morph_p_pc,                                 /*    686 */
  Parrot_clone_s_s,                                  /*    687 */
  Parrot_clone_s_sc,                                 /*    688 */
  Parrot_set_i_i,                                    /*    689 */
  Parrot_set_i_ic,                                   /*    690 */
  Parrot_set_i_n,                                    /*    691 */
  Parrot_set_i_nc,                                   /*    692 */
  ...
  Parrot_set_p_sc,                                   /*    716 */
  Parrot_set_i_p,                                    /*    717 */
  Parrot_assign_p_p,                                 /*    718 */
  Parrot_assign_p_i,                                 /*    719 */
  Parrot_assign_p_ic,                                /*    720 */
  Parrot_assign_p_n,                                 /*    721 */
  Parrot_assign_p_nc,                                /*    722 */
  Parrot_assign_p_s,                                 /*    723 */
  Parrot_assign_p_sc,                                /*    724 */
  Parrot_assign_s_s,                                 /*    725 */
  Parrot_assign_s_sc,                                /*    726 */
  Parrot_setref_p_p,                                 /*    727 */
  Parrot_deref_p_p,                                  /*    728 */
  Parrot_set_p_ki_i,                                 /*    729 */
  Parrot_set_p_kic_i,                                /*    730 */
  Parrot_set_p_ki_ic,                                /*    731 */
  Parrot_set_p_kic_ic,                               /*    732 */
  Parrot_set_p_ki_n,                                 /*    733 */
  Parrot_set_p_kic_n,                                /*    734 */
  Parrot_set_p_ki_nc,                                /*    735 */
  Parrot_set_p_kic_nc,                               /*    736 */
  Parrot_set_p_ki_s,                                 /*    737 */
  Parrot_set_p_kic_s,                                /*    738 */
  Parrot_set_p_ki_sc,                                /*    739 */
  Parrot_set_p_kic_sc,                               /*    740 */
  Parrot_set_p_ki_p,                                 /*    741 */
  Parrot_set_p_kic_p,                                /*    742 */
  Parrot_set_i_p_ki,                                 /*    743 */
  Parrot_set_i_p_kic,                                /*    744 */
  Parrot_set_n_p_ki,                                 /*    745 */
  Parrot_set_n_p_kic,                                /*    746 */
  Parrot_set_s_p_ki,                                 /*    747 */
  Parrot_set_s_p_kic,                                /*    748 */
  Parrot_set_p_p_ki,                                 /*    749 */
  Parrot_set_p_p_kic,                                /*    750 */
  Parrot_set_p_k_i,                                  /*    751 */
  Parrot_set_p_kc_i,                                 /*    752 */
  Parrot_set_p_k_ic,                                 /*    753 */
  Parrot_set_p_kc_ic,                                /*    754 */
  Parrot_set_p_k_n,                                  /*    755 */
  Parrot_set_p_kc_n,                                 /*    756 */
  Parrot_set_p_k_nc,                                 /*    757 */
  Parrot_set_p_kc_nc,                                /*    758 */
  Parrot_set_p_k_s,                                  /*    759 */
  Parrot_set_p_kc_s,                                 /*    760 */
  Parrot_set_p_k_sc,                                 /*    761 */
  Parrot_set_p_kc_sc,                                /*    762 */
  Parrot_set_p_k_p,                                  /*    763 */
  Parrot_set_p_kc_p,                                 /*    764 */
  Parrot_set_i_p_k,                                  /*    765 */
  Parrot_set_i_p_kc,                                 /*    766 */
  Parrot_set_n_p_k,                                  /*    767 */
  Parrot_set_n_p_kc,                                 /*    768 */
  Parrot_set_s_p_k,                                  /*    769 */
  Parrot_set_s_p_kc,                                 /*    770 */
  Parrot_set_p_p_k,                                  /*    771 */
  Parrot_set_p_p_kc,                                 /*    772 */
  Parrot_clone_p_p,                                  /*    773 */
  Parrot_clone_p_p_p,                                /*    774 */
  Parrot_clone_p_p_pc,                               /*    775 */
  Parrot_copy_p_p,                                   /*    776 */
  Parrot_null_s,                                     /*    777 */
  Parrot_null_i,                                     /*    778 */
  Parrot_null_p,                                     /*    779 */
  ...
  Parrot_ord_i_s,                                    /*    781 */
  Parrot_ord_i_sc,                                   /*    782 */
  Parrot_ord_i_s_i,                                  /*    783 */
  Parrot_ord_i_sc_i,                                 /*    784 */
  Parrot_ord_i_s_ic,                                 /*    785 */
  Parrot_ord_i_sc_ic,                                /*    786 */
  Parrot_chr_s_i,                                    /*    787 */
  Parrot_chr_s_ic,                                   /*    788 */
  Parrot_chopn_s_s_i,                                /*    789 */
  Parrot_chopn_s_sc_i,                               /*    790 */
  Parrot_chopn_s_s_ic,                               /*    791 */
  Parrot_chopn_s_sc_ic,                              /*    792 */
  Parrot_concat_p_p,                                 /*    793 */
  Parrot_concat_p_s,                                 /*    794 */
  Parrot_concat_p_sc,                                /*    795 */
  Parrot_concat_s_s_s,                               /*    796 */
  Parrot_concat_s_sc_s,                              /*    797 */
  Parrot_concat_s_s_sc,                              /*    798 */
  Parrot_concat_p_p_s,                               /*    799 */
  Parrot_concat_p_p_sc,                              /*    800 */
  Parrot_concat_p_p_p,                               /*    801 */
  Parrot_repeat_s_s_i,                               /*    802 */
  Parrot_repeat_s_sc_i,                              /*    803 */
  Parrot_repeat_s_s_ic,                              /*    804 */
  Parrot_repeat_s_sc_ic,                             /*    805 */
  Parrot_repeat_p_p_i,                               /*    806 */
  Parrot_repeat_p_p_ic,                              /*    807 */
  Parrot_repeat_p_p_p,                               /*    808 */
  Parrot_repeat_p_i,                                 /*    809 */
  Parrot_repeat_p_ic,                                /*    810 */
  Parrot_repeat_p_p,                                 /*    811 */
  Parrot_length_i_s,                                 /*    812 */
  Parrot_length_i_sc,                                /*    813 */
  Parrot_bytelength_i_s,                             /*    814 */
  Parrot_bytelength_i_sc,                            /*    815 */
  Parrot_pin_s,                                      /*    816 */
  Parrot_unpin_s,                                    /*    817 */
  Parrot_substr_s_s_i,                               /*    818 */
  Parrot_substr_s_sc_i,                              /*    819 */
  Parrot_substr_s_s_ic,                              /*    820 */
  Parrot_substr_s_sc_ic,                             /*    821 */
  Parrot_substr_s_s_i_i,                             /*    822 */
  Parrot_substr_s_sc_i_i,                            /*    823 */
  Parrot_substr_s_s_ic_i,                            /*    824 */
  Parrot_substr_s_sc_ic_i,                           /*    825 */
  Parrot_substr_s_s_i_ic,                            /*    826 */
  Parrot_substr_s_sc_i_ic,                           /*    827 */
  Parrot_substr_s_s_ic_ic,                           /*    828 */
  Parrot_substr_s_sc_ic_ic,                          /*    829 */
  Parrot_substr_s_p_i_i,                             /*    830 */
  Parrot_substr_s_p_ic_i,                            /*    831 */
  Parrot_substr_s_p_i_ic,                            /*    832 */
  Parrot_substr_s_p_ic_ic,                           /*    833 */
  Parrot_replace_s_s_i_i_s,                          /*    834 */
  Parrot_replace_s_sc_i_i_s,                         /*    835 */
  Parrot_replace_s_s_ic_i_s,                         /*    836 */
  Parrot_replace_s_sc_ic_i_s,                        /*    837 */
  Parrot_replace_s_s_i_ic_s,                         /*    838 */
  Parrot_replace_s_sc_i_ic_s,                        /*    839 */
  Parrot_replace_s_s_ic_ic_s,                        /*    840 */
  Parrot_replace_s_sc_ic_ic_s,                       /*    841 */
  Parrot_replace_s_s_i_i_sc,                         /*    842 */
  Parrot_replace_s_sc_i_i_sc,                        /*    843 */
  Parrot_replace_s_s_ic_i_sc,                        /*    844 */
  Parrot_replace_s_sc_ic_i_sc,                       /*    845 */
  Parrot_replace_s_s_i_ic_sc,                        /*    846 */
  Parrot_replace_s_sc_i_ic_sc,                       /*    847 */
  Parrot_replace_s_s_ic_ic_sc,                       /*    848 */
  Parrot_replace_s_sc_ic_ic_sc,                      /*    849 */
  Parrot_index_i_s_s,                                /*    850 */
  Parrot_index_i_sc_s,                               /*    851 */
  Parrot_index_i_s_sc,                               /*    852 */
  Parrot_index_i_sc_sc,                              /*    853 */
  Parrot_index_i_s_s_i,                              /*    854 */
  Parrot_index_i_sc_s_i,                             /*    855 */
  Parrot_index_i_s_sc_i,                             /*    856 */
  Parrot_index_i_sc_sc_i,                            /*    857 */
  Parrot_index_i_s_s_ic,                             /*    858 */
  Parrot_index_i_sc_s_ic,                            /*    859 */
  Parrot_index_i_s_sc_ic,                            /*    860 */
  Parrot_index_i_sc_sc_ic,                           /*    861 */
  Parrot_sprintf_s_s_p,                              /*    862 */
  Parrot_sprintf_s_sc_p,                             /*    863 */
  Parrot_sprintf_p_p_p,                              /*    864 */
  Parrot_new_s,                                      /*    865 */
  Parrot_new_s_i,                                    /*    866 */
  Parrot_new_s_ic,                                   /*    867 */
  Parrot_stringinfo_i_s_i,                           /*    868 */
  Parrot_stringinfo_i_sc_i,                          /*    869 */
  Parrot_stringinfo_i_s_ic,                          /*    870 */
  Parrot_stringinfo_i_sc_ic,                         /*    871 */
  Parrot_upcase_s_s,                                 /*    872 */
  Parrot_upcase_s_sc,                                /*    873 */
  Parrot_downcase_s_s,                               /*    874 */
  Parrot_downcase_s_sc,                              /*    875 */
  Parrot_titlecase_s_s,                              /*    876 */
  Parrot_titlecase_s_sc,                             /*    877 */
  Parrot_join_s_s_p,                                 /*    878 */
  Parrot_join_s_sc_p,                                /*    879 */
  Parrot_split_p_s_s,                                /*    880 */
  Parrot_split_p_sc_s,                               /*    881 */
  Parrot_split_p_s_sc,                               /*    882 */
  Parrot_split_p_sc_sc,                              /*    883 */
  Parrot_encoding_i_s,                               /*    884 */
  Parrot_encoding_i_sc,                              /*    885 */
  Parrot_encodingname_s_i,                           /*    886 */
  Parrot_encodingname_s_ic,                          /*    887 */
  Parrot_find_encoding_i_s,                          /*    888 */
  Parrot_find_encoding_i_sc,                         /*    889 */
  Parrot_trans_encoding_s_s_i,                       /*    890 */
  Parrot_trans_encoding_s_sc_i,                      /*    891 */
  Parrot_trans_encoding_s_s_ic,                      /*    892 */
  Parrot_trans_encoding_s_sc_ic,                     /*    893 */
  Parrot_is_cclass_i_i_s_i,                          /*    894 */
  Parrot_is_cclass_i_ic_s_i,                         /*    895 */
  Parrot_is_cclass_i_i_sc_i,                         /*    896 */
  Parrot_is_cclass_i_ic_sc_i,                        /*    897 */
  Parrot_is_cclass_i_i_s_ic,                         /*    898 */
  Parrot_is_cclass_i_ic_s_ic,                        /*    899 */
  Parrot_is_cclass_i_i_sc_ic,                        /*    900 */
  Parrot_is_cclass_i_ic_sc_ic,                       /*    901 */
  Parrot_find_cclass_i_i_s_i_i,                      /*    902 */
  Parrot_find_cclass_i_ic_s_i_i,                     /*    903 */
  Parrot_find_cclass_i_i_sc_i_i,                     /*    904 */
  Parrot_find_cclass_i_ic_sc_i_i,                    /*    905 */
  Parrot_find_cclass_i_i_s_ic_i,                     /*    906 */
  Parrot_find_cclass_i_ic_s_ic_i,                    /*    907 */
  Parrot_find_cclass_i_i_sc_ic_i,                    /*    908 */
  Parrot_find_cclass_i_ic_sc_ic_i,                   /*    909 */
  Parrot_find_cclass_i_i_s_i_ic,                     /*    910 */
  Parrot_find_cclass_i_ic_s_i_ic,                    /*    911 */
  Parrot_find_cclass_i_i_sc_i_ic,                    /*    912 */
  Parrot_find_cclass_i_ic_sc_i_ic,                   /*    913 */
  Parrot_find_cclass_i_i_s_ic_ic,                    /*    914 */
  Parrot_find_cclass_i_ic_s_ic_ic,                   /*    915 */
  Parrot_find_cclass_i_i_sc_ic_ic,                   /*    916 */
  Parrot_find_cclass_i_ic_sc_ic_ic,                  /*    917 */
  Parrot_find_not_cclass_i_i_s_i_i,                  /*    918 */
  Parrot_find_not_cclass_i_ic_s_i_i,                 /*    919 */
  Parrot_find_not_cclass_i_i_sc_i_i,                 /*    920 */
  Parrot_find_not_cclass_i_ic_sc_i_i,                /*    921 */
  Parrot_find_not_cclass_i_i_s_ic_i,                 /*    922 */
  Parrot_find_not_cclass_i_ic_s_ic_i,                /*    923 */
  Parrot_find_not_cclass_i_i_sc_ic_i,                /*    924 */
  Parrot_find_not_cclass_i_ic_sc_ic_i,               /*    925 */
  Parrot_find_not_cclass_i_i_s_i_ic,                 /*    926 */
  Parrot_find_not_cclass_i_ic_s_i_ic,                /*    927 */
  Parrot_find_not_cclass_i_i_sc_i_ic,                /*    928 */
  Parrot_find_not_cclass_i_ic_sc_i_ic,               /*    929 */
  Parrot_find_not_cclass_i_i_s_ic_ic,                /*    930 */
  Parrot_find_not_cclass_i_ic_s_ic_ic,               /*    931 */
  Parrot_find_not_cclass_i_i_sc_ic_ic,               /*    932 */
  Parrot_find_not_cclass_i_ic_sc_ic_ic,              /*    933 */
  Parrot_escape_s_s,                                 /*    934 */
  Parrot_compose_s_s,                                /*    935 */
  Parrot_compose_s_sc,                               /*    936 */
  Parrot_find_codepoint_i_s,                         /*    937 */
  Parrot_find_codepoint_i_sc,                        /*    938 */
  Parrot_spawnw_i_s,                                 /*    939 */
  Parrot_spawnw_i_sc,                                /*    940 */
  Parrot_spawnw_i_p,                                 /*    941 */
  Parrot_err_i,                                      /*    942 */
  Parrot_err_s,                                      /*    943 */
  Parrot_err_s_i,                                    /*    944 */
  Parrot_err_s_ic,                                   /*    945 */
  ...
  Parrot_sleep_n,                                    /*    950 */
  Parrot_sleep_nc,                                   /*    951 */
  Parrot_store_lex_s_p,                              /*    952 */
  Parrot_store_lex_sc_p,                             /*    953 */
  Parrot_store_dynamic_lex_s_p,                      /*    954 */
  Parrot_store_dynamic_lex_sc_p,                     /*    955 */
  Parrot_find_lex_p_s,                               /*    956 */
  Parrot_find_lex_p_sc,                              /*    957 */
  Parrot_find_dynamic_lex_p_s,                       /*    958 */
  Parrot_find_dynamic_lex_p_sc,                      /*    959 */
  Parrot_find_caller_lex_p_s,                        /*    960 */
  Parrot_find_caller_lex_p_sc,                       /*    961 */
  Parrot_get_namespace_p,                            /*    962 */
  Parrot_get_namespace_p_p,                          /*    963 */
  Parrot_get_namespace_p_pc,                         /*    964 */
  Parrot_get_hll_namespace_p,                        /*    965 */
  Parrot_get_hll_namespace_p_p,                      /*    966 */
  Parrot_get_hll_namespace_p_pc,                     /*    967 */
  Parrot_get_root_namespace_p,                       /*    968 */
  Parrot_get_root_namespace_p_p,                     /*    969 */
  Parrot_get_root_namespace_p_pc,                    /*    970 */
  Parrot_get_global_p_s,                             /*    971 */
  Parrot_get_global_p_sc,                            /*    972 */
  Parrot_get_global_p_p_s,                           /*    973 */
  Parrot_get_global_p_pc_s,                          /*    974 */
  Parrot_get_global_p_p_sc,                          /*    975 */
  Parrot_get_global_p_pc_sc,                         /*    976 */
  Parrot_get_hll_global_p_s,                         /*    977 */
  Parrot_get_hll_global_p_sc,                        /*    978 */
  Parrot_get_hll_global_p_p_s,                       /*    979 */
  Parrot_get_hll_global_p_pc_s,                      /*    980 */
  Parrot_get_hll_global_p_p_sc,                      /*    981 */
  Parrot_get_hll_global_p_pc_sc,                     /*    982 */
  Parrot_get_root_global_p_s,                        /*    983 */
  Parrot_get_root_global_p_sc,                       /*    984 */
  Parrot_get_root_global_p_p_s,                      /*    985 */
  Parrot_get_root_global_p_pc_s,                     /*    986 */
  Parrot_get_root_global_p_p_sc,                     /*    987 */
  Parrot_get_root_global_p_pc_sc,                    /*    988 */
  Parrot_set_global_s_p,                             /*    989 */
  Parrot_set_global_sc_p,                            /*    990 */
  Parrot_set_global_p_s_p,                           /*    991 */
  Parrot_set_global_pc_s_p,                          /*    992 */
  Parrot_set_global_p_sc_p,                          /*    993 */
  Parrot_set_global_pc_sc_p,                         /*    994 */
  Parrot_set_hll_global_s_p,                         /*    995 */
  Parrot_set_hll_global_sc_p,                        /*    996 */
  Parrot_set_hll_global_p_s_p,                       /*    997 */
  Parrot_set_hll_global_pc_s_p,                      /*    998 */
  Parrot_set_hll_global_p_sc_p,                      /*    999 */
  Parrot_set_hll_global_pc_sc_p,                     /*   1000 */
  Parrot_set_root_global_s_p,                        /*   1001 */
  Parrot_set_root_global_sc_p,                       /*   1002 */
  Parrot_set_root_global_p_s_p,                      /*   1003 */
  Parrot_set_root_global_pc_s_p,                     /*   1004 */
  Parrot_set_root_global_p_sc_p,                     /*   1005 */
  Parrot_set_root_global_pc_sc_p,                    /*   1006 */
  Parrot_find_name_p_s,                              /*   1007 */
  Parrot_find_name_p_sc,                             /*   1008 */
  Parrot_find_sub_not_null_p_s,                      /*   1009 */
  Parrot_find_sub_not_null_p_sc,                     /*   1010 */
  Parrot_trap,                                       /*   1011 */
  Parrot_set_label_p_ic,                             /*   1012 */
  Parrot_get_label_i_p,                              /*   1013 */
  Parrot_fetch_p_p_p_p,                              /*   1014 */
  Parrot_fetch_p_pc_p_p,                             /*   1015 */
  Parrot_fetch_p_p_pc_p,                             /*   1016 */
  Parrot_fetch_p_pc_pc_p,                            /*   1017 */
  Parrot_fetch_p_p_p_pc,                             /*   1018 */
  Parrot_fetch_p_pc_p_pc,                            /*   1019 */
  Parrot_fetch_p_p_pc_pc,                            /*   1020 */
  Parrot_fetch_p_pc_pc_pc,                           /*   1021 */
  Parrot_fetch_p_p_i_p,                              /*   1022 */
  Parrot_fetch_p_pc_i_p,                             /*   1023 */
  Parrot_fetch_p_p_ic_p,                             /*   1024 */
  Parrot_fetch_p_pc_ic_p,                            /*   1025 */
  Parrot_fetch_p_p_i_pc,                             /*   1026 */
  Parrot_fetch_p_pc_i_pc,                            /*   1027 */
  Parrot_fetch_p_p_ic_pc,                            /*   1028 */
  Parrot_fetch_p_pc_ic_pc,                           /*   1029 */
  Parrot_fetch_p_p_s_p,                              /*   1030 */
  Parrot_fetch_p_pc_s_p,                             /*   1031 */
  Parrot_fetch_p_p_sc_p,                             /*   1032 */
  Parrot_fetch_p_pc_sc_p,                            /*   1033 */
  Parrot_fetch_p_p_s_pc,                             /*   1034 */
  Parrot_fetch_p_pc_s_pc,                            /*   1035 */
  Parrot_fetch_p_p_sc_pc,                            /*   1036 */
  Parrot_fetch_p_pc_sc_pc,                           /*   1037 */
  Parrot_vivify_p_p_p_p,                             /*   1038 */
  Parrot_vivify_p_pc_p_p,                            /*   1039 */
  Parrot_vivify_p_p_pc_p,                            /*   1040 */
  Parrot_vivify_p_pc_pc_p,                           /*   1041 */
  Parrot_vivify_p_p_p_pc,                            /*   1042 */
  Parrot_vivify_p_pc_p_pc,                           /*   1043 */
  Parrot_vivify_p_p_pc_pc,                           /*   1044 */
  Parrot_vivify_p_pc_pc_pc,                          /*   1045 */
  Parrot_vivify_p_p_i_p,                             /*   1046 */
  Parrot_vivify_p_pc_i_p,                            /*   1047 */
  Parrot_vivify_p_p_ic_p,                            /*   1048 */
  Parrot_vivify_p_pc_ic_p,                           /*   1049 */
  Parrot_vivify_p_p_i_pc,                            /*   1050 */
  Parrot_vivify_p_pc_i_pc,                           /*   1051 */
  Parrot_vivify_p_p_ic_pc,                           /*   1052 */
  Parrot_vivify_p_pc_ic_pc,                          /*   1053 */
  Parrot_vivify_p_p_s_p,                             /*   1054 */
  Parrot_vivify_p_pc_s_p,                            /*   1055 */
  Parrot_vivify_p_p_sc_p,                            /*   1056 */
  Parrot_vivify_p_pc_sc_p,                           /*   1057 */
  Parrot_vivify_p_p_s_pc,                            /*   1058 */
  Parrot_vivify_p_pc_s_pc,                           /*   1059 */
  Parrot_vivify_p_p_sc_pc,                           /*   1060 */
  Parrot_vivify_p_pc_sc_pc,                          /*   1061 */
  Parrot_new_p_s_i,                                  /*   1062 */
  Parrot_new_p_sc_i,                                 /*   1063 */
  Parrot_new_p_s_ic,                                 /*   1064 */
  Parrot_new_p_sc_ic,                                /*   1065 */
  Parrot_new_p_p_i,                                  /*   1066 */
  Parrot_new_p_pc_i,                                 /*   1067 */
  Parrot_new_p_p_ic,                                 /*   1068 */
  Parrot_new_p_pc_ic,                                /*   1069 */
  Parrot_root_new_p_p_i,                             /*   1070 */
  Parrot_root_new_p_pc_i,                            /*   1071 */
  Parrot_root_new_p_p_ic,                            /*   1072 */
  Parrot_root_new_p_pc_ic,                           /*   1073 */
...
static op_info_t core_op_info_table[1075] = {
  { /* 0 */
    "end",
    "end",
    "Parrot_end",
